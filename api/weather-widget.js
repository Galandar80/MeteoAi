...
const { getForecast } = require('./_forecast-cache');
const rounded=value=>typeof value==='number'&&Number.isFinite(value)?Math.round(value):'—';
...
module.exports = async function handler(req, res) {
  ...
  const forecastResult=await getForecast(place), data=forecastResult.data, current=data?.current, daily=data?.daily;
