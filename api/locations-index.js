...
<body>
  ...
  <footer><p><a href="${locale.homePath}">Meteo AI</a> • <a href="${locale.tomorrowPath}">${escapeHtml(locale.tomorrowHubLabel)}</a> • <a href="${locale.howPath}">${escapeHtml(locale.howLabel)}</a> • <a href="${locale.widgetPath}">${escapeHtml(locale.widgetLabel)}</a></p><p>${locale.footerDirectory}</p></footer>
</body>
</html>`);
};
