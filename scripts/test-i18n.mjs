...
for(const file of ['manifest.webmanifest','manifest.en.webmanifest','manifest.fr.webmanifest','manifest.pt-BR.webmanifest'])JSON.parse(fs.readFileSync(new URL(`../${file}`,import.meta.url),'utf8'));
